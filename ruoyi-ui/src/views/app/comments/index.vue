<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="被评论id" prop="toId">
        <el-input
          v-model="queryParams.toId"
          placeholder="请输入被评论id"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="被评论帖子id" prop="pid">
        <el-input
          v-model="queryParams.pid"
          placeholder="请输入被评论帖子id"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['app:comments:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['app:comments:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="commentsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="被评论id" align="center" prop="toId" />
      <el-table-column label="被评论帖子id" align="center" prop="pid" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="被评论id" prop="toId">
          <el-input v-model="form.toId" placeholder="请输入被评论id" />
        </el-form-item>
        <el-form-item label="被评论帖子id" prop="pid">
          <el-input v-model="form.pid" placeholder="请输入被评论帖子id" />
        </el-form-item>
...
<script>
import { listComments, getComments, delComments, addComments, updateComments } from "@/api/app/comments";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('app/comments/export', {
        ...this.queryParams
